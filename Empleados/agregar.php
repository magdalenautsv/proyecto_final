			...
			<div class="panel-body">
				<form name="form" action="" method="post">
					...
					<div class="form-group">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<div class="input-group-text"><i class="fa fa-user bigicon"></i> Usuario</div>
							</div>
					...
					<div class="form-group">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<div class="input-group-text"><i class="fa fa-user bigicon"></i> Contraseña</div>
							</div>
					...
					<div class="form-group">
						<div class="input-group mb-3">
							...
							<input id="lname" name="fecha_nac" type="date" placeholder="Ingresar Direccion" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group mb-3">
					...
					<div class="form-group">
						<div class="input-group mb-3">
							<textarea class="form-control" id="message" name="comentario" placeholder="Escribenos tus dudas y sugerencias" rows="7"></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="d-grid gap-4 col-6  mx-auto">
							<button type="submit" class="btn btn-primary btn-lg"><h2>Guardar</h2></button>
						</div>
					</div>
				</form>
			</div>
